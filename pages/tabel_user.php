...
?>
<!-- tabel User-->
<div class="row titlepanel" style="margin-left: 23%">
    <div class="col-12">
        <h1>Tabel User</h1>
    </div>
</div>
<table class="table table_spesialis" style="margin-left: 23%">
            ...
            <tr>
                ...
                <td><button type="button" class="btn btn-outline-danger" data-toggle="modal"
                    ...
                    <button type="button" class="btn btn-outline-dark" data-toggle="modal"
                        data-target="#detail_user_<?= $row['id_user'] ?>" data-whatever="@getbootstrap">Detail</button></td>
            </tr>
