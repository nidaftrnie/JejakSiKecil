...
<body>
    <div class="container">
        <div class="col-lg-12 mt-5 pt-5">
            <div class="row edit_profile" style="margin-left: 35%">
                <div class="col-lg-4">
                ...
                <div class="col-lg-6">
                    ...
                    <a href="#" class="btn btn-outline-dark tombol_edit_profile" data-toggle="modal"
                ...
                <table class="table table_privacy">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Password</td>
                            <td>*************</td>
                            <td><button type="button" class="btn btn-outline-dark" data-toggle="modal"
                                    data-target="#edit_pw" data-whatever="@getbootstrap">Edit Password</button></td>
                        </tr>
                    </tbody>
                </table>
